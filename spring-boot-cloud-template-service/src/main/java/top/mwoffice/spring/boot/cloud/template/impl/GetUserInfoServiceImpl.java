package top.mwoffice.spring.boot.cloud.template.impl;


import top.mwoffice.spring.boot.cloud.template.mybatis.entity.MVCMybatisDemoUser;
import top.mwoffice.spring.boot.cloud.template.mybatis.mapper.MVCMybatisDemoUserMapper;
import top.mwoffice.spring.boot.cloud.template.GetUserInfoService;
